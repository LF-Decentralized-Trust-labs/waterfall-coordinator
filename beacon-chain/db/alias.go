...
// ReadOnlyDatabase exposes data backend for read access only, no information about
...
// NoHeadAccessDatabase exposes data backend for read/write access, no information
...
// HeadAccessDatabase exposes backend for read/write access with information about
...
// Database defines the necessary methods for backend which may be implemented by any
