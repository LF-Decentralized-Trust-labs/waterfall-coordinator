...
var file_proto_eth_v1_beacon_block_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x65, 0x53, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0x55, 0x0a, 0x11,
	0x56, 0x6f, 0x6c, 0x75, 0x6e, 0x74, 0x61, 0x72, 0x79, 0x45, 0x78, 0x69, 0x74, 0x4c, 0x69, 0x73,
	...
	0x0c, 0x92, 0xb5, 0x18, 0x08, 0x31, 0x36, 0x37, 0x37, 0x37, 0x32, 0x31, 0x36, 0x52, 0x04, 0x64,
	0x61, 0x74, 0x61, 0x22, 0x4f, 0x0a, 0x0e, 0x57, 0x69, 0x74, 0x68, 0x64, 0x72, 0x61, 0x77, 0x61,
	0x6c, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x3d, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x01, 0x20,
	...
	0x42, 0x0c, 0x92, 0xb5, 0x18, 0x08, 0x31, 0x36, 0x37, 0x37, 0x37, 0x32, 0x31, 0x36, 0x52, 0x04,
	0x64, 0x61, 0x74, 0x61, 0x42, 0x93, 0x01, 0x0a, 0x13, 0x6f, 0x72, 0x67, 0x2e, 0x65, 0x74, 0x68,
...
var file_proto_eth_v1_beacon_block_proto_goTypes = []interface{}{
	...
	(*VoluntaryExitList)(nil),       // 13: ethereum.eth.v1.VoluntaryExitList
	(*WithdrawalList)(nil),          // 14: ethereum.eth.v1.WithdrawalList
...
var file_proto_eth_v1_beacon_block_proto_depIdxs = []int32{
	...
	16, // 5: ethereum.eth.v1.BeaconBlockBody.attestations:type_name -> ethereum.eth.v1.Attestation
	...
	15, // 13: ethereum.eth.v1.Deposit.data:type_name -> ethereum.eth.v1.Deposit.Data
	9,  // 14: ethereum.eth.v1.SignedBeaconBlockHeader.message:type_name -> ethereum.eth.v1.BeaconBlockHeader
	17, // 15: ethereum.eth.v1.IndexedAttestation.data:type_name -> ethereum.eth.v1.AttestationData
	6,  // 16: ethereum.eth.v1.VoluntaryExitList.data:type_name -> ethereum.eth.v1.VoluntaryExit
	7,  // 17: ethereum.eth.v1.WithdrawalList.data:type_name -> ethereum.eth.v1.Withdrawal
